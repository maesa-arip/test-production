    ...
    return (
        ...
        <div className="space-y-4">
            ...
            {products.length ? products.map(product => (
                <div className="bg-white flex gap-x-4 p-4 rounded-lg shadow" key={product.id}>
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center text-sm gap-x-4">
                                {/* <div className="text-blue-500 font-semibold">{product.user.name}</div> */}
                                <Link href={`/toko/products/table?category=${product.category.slug}`} className="hidden md:block text-gray-500 font-semibold text-sm">{product.category.name}</Link>
                                <span className="text-gray-500 hidden md:block">{product.created_at}</span>
                            </div>
                            <div className="flex items-center text-sm gap-x-4">
                                <span>
